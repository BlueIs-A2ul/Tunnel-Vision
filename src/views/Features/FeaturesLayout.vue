    ...
    <div class="w-[98%] mx-auto pt-3 flex-1 flex flex-col">
      <div class="mb-3">
        <div
          ...
          <Icon icon="material-symbols:more" :size="20" color="#4b8df8"></Icon>
          其他功能
        </div>
      </div>
      <div class="flex flex-1">
        <aside class="w-[220px] bg-[#072951] border-r border-[#034c6a] shrink-0 flex flex-col">
          <div
            class="py-3.5 px-5 text-sm font-semibold text-white bg-[#034c6a] text-center mx-3 mt-3 mb-2 rounded-[18px]">
            功能列表</div>
          <nav class="flex flex-col gap-0.5 px-3 py-1">
            <button v-for="item in featureMenus" :key="item.path" :class="[
